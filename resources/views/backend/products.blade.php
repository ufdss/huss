...
<div class="br-section-wrapper">
    <div class="row mg-b-10">
        <div class="col-md-2">
            <a href="{{ route('backend.products.create') }}" class="btn btn-outline-dark form-control"><i class="fa fa-plus"></i> @lang('Add New')</a>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.products.updateAll','method'=>'post'])}}
        ...
        <table id="datatable" class="table display responsive nowrap">
            ...
            <tr>
                ...
                <th class="">القسم</th>
                <th class="">العضو</th>
                <th class="">إسم المعرض</th>
                <th class="">الإسم</th>
                <th class="">الوصف</th>
                <th class="">السعر</th>
                <th class="">في المخزن</th>
                <th class="">المقاس</th>
                <th class="">الحاله</th>
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.products.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
