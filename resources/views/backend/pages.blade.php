...
<div class="br-section-wrapper">
    <div class="row mg-b-10">
        <div class="col-md-2">
            <a href="{{ route('backend.pages.create') }}" class="btn btn-outline-dark form-control"><i class="fa fa-plus"></i> @lang('Add New')</a>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.pages.updateAll','method'=>'post'])}}

        <table id="datatable" class="table display responsive nowrap">
            <thead>
            <tr>
                <th class="wd-10-force"></th>
                <th class="wd-25">@lang('#')</th>
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.pages.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
