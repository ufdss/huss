...
<div class="br-section-wrapper">
    <div class="row mg-b-10">
        <div class="col-md-2">
            <a href="{{ route('backend.paymentmethods.create') }}" class="btn btn-outline-dark form-control"><i class="fa fa-plus"></i> @lang('Add New')</a>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.paymentmethods.updateAll','method'=>'post'])}}
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.paymentmethods.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
