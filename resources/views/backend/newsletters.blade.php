    ...
    <div class="row mg-b-10">
        <div class="col-md-12">
            <div class="d-flex justify-content-between mg-b-5">
                <a href="{{ route('backend.newsletters.create') }}" class="btn wd-15p-force btn-outline-dark form-control right"><i class="fa fa-plus"></i> @lang('Add New')</a>
                <a href="#" class="btn wd-15p-force btn-outline-dark form-control "><i class="fa fa-envelope"></i> @lang('Send')</a>
            </div>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.newsletters.updateAll','method'=>'post'])}}
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.newsletters.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
