...
<div class="col-lg-12" style="margin-bottom: 28px;">
    <div class="custom-file mg-t-30">
        {!! Form::file('attachments[]',array('class' => 'custom-file-input','id'=>'coaver','multiple'=>'yes')) !!}
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        {!! Form::text('name_and_type',null, array('placeholder' =>  'إسم و نوع المنتج','class' => 'form-control','id' => 'name_and_type')) !!}
    </div>
</div>
...
<div class="col-lg-4">
    <div class="form-group">
        ...
        {!! Form::text('branch_name',null, array('placeholder' =>  'إسم المعرض','class' => 'form-control')) !!}
    </div>
</div>
