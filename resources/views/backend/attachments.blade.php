...
<div class="br-section-wrapper">
    ...
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.attachments.updateAll','method'=>'post'])}}
        ...
        <table id="datatable" class="table display responsive nowrap">
            ...
            <tr>
                ...
                <th class="">@lang('Mime')</th>
                <th class="">@lang('Refrence')</th>
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.attachments.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
                ...
                {data: 'size', name: 'size'},
                {data: 'mime', name: 'mime'},
                {data: 'attachable_type', name: 'attachable_type'},
