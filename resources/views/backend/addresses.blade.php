...
<div class="br-section-wrapper">
    <div class="row mg-b-10">
        <div class="col-md-2">
            <a href="{{ route('backend.addresses.create') }}" class="btn btn-outline-dark form-control"><i class="fa fa-plus"></i> @lang('Add New')</a>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.addresses.updateAll','method'=>'post'])}}
        ...
        <table id="datatable" class="table display responsive nowrap">
            ...
            <tr>
                ...
                <th class="">@lang('#')</th>
                <th class="">@lang('first_name')</th>
                <th class="">@lang('area_id')</th>
                <th class="">@lang('address1')</th>
                <th class="">@lang('user_id')</th>
                <th class="">@lang('phone1')</th>
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.addresses.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
