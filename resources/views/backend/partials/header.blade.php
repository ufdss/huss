        ...
        <nav class="nav">
            ...
            <div class="dropdown">
                <a href="" class="nav-link pd-x-7 pos-relative" data-toggle="dropdown">
                    ...
                    <audio controls id="nth" style="display:none">
                        <source  src="{{asset('audio/plucky.mp3')}}" type="audio/mpeg">
                    </audio>
                ...
                <div class="dropdown-menu dropdown-menu-header">
                    ...
                    <div class="media-list">
                            ...
                            @forelse (auth()->user()->notifications as $key => $value)

                                <!-- loop starts here -->
                                <a id="read_notify" data-link="{{$value->data['link']}}" data-notity_id = "{{$value->id}}" href="{{url(''.$value->data['link'])}}" class="media-list-link {{($value->read_at == null) ? '':'read'}}">
                                    <div class="media">
                                        <img src="img/img8.jpg" alt="">
                                        <div class="media-body">
                                            <p class="noti-text"> {{$value->data['msg']}}                                                </p>
                             ...
                             @empty
                                <br>
                                <p style="text-align: center">لا توجد إشعارات حاليا</p>
                        ...
                        <div class="dropdown-footer">
                            <a href=""><i class="fa fa-angle-down"></i> مشاهدت جميع الإشعارات</a>
                        </div>
                    </div><!-- media-list -->
                </div><!-- dropdown-menu -->
            </div><!-- dropdown -->
            <div class="dropdown">
                <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                    <span class="logged-name hidden-md-down">{{Auth()->guard()->user()->name}}</span>
