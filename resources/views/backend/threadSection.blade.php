...
<div class="br-section-wrapper">
    <div class="row mg-b-10">
        <div class="col-md-2">
            <a href="{{ route('backend.threadSection.create') }}" class="btn btn-outline-dark form-control"><i class="fa fa-plus"></i> @lang('Add New')</a>
        </div>
    </div>
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.threadSection.updateAll','method'=>'post'])}}
        ...
        <table id="datatable" class="table display responsive nowrap">
            ...
            <tr>
                ...
                <th class="">@lang('body')</th>
                <th class="">@lang('Slug')</th>
...
<script>
    loadjs([
        ...
        $('#datatable').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('backend.threadSection.datatable') !!}',
            columns: [
                {
                    orderable: false,
                    sortable: false,
