...
<div class="br-section-wrapper">
    ...
    <div class="table-wrapper">
        {{Form::open(['route'=>'backend.orders.updateAll','method'=>'post'])}}
        ...
        <table id="datatable" class="table display responsive nowrap">
            ...
            <tr>
                ...
                <th class="">@lang('Comment')</th>
                <th class="">@lang('Status')</th>
                <th class="">@lang('User')</th>
                <th class="">@lang('Invoice Date')</th>
                <th class="">@lang('Delivery Date')</th>
                <th class="">@lang('Total')</th>
                <th class="">@lang('Total Amount')</th>
                <th class="">@lang('Total Discount')</th>
                <th class="">@lang('Total Shipping')</th>
                <th class="">@lang('Shipping Address')</th>
    ...
    loadjs([
        ...
        $(document).ready(function() {
            $('#datatable').DataTable( {
                ...
                "searching": false,
                "ajax": {
                    "url": "{!! route('backend.orders.datatable') !!}",
                    "type": "GET",
                },
                "columns": [
                    {
                    ...
                    // {data: 'shipping_address_id', name: 'shipping_address_id'},
        ...
        {{--$('#datatable').DataTable({--}}
            ...
            {{--processing: true,--}}
            {{--serverSide: true,--}}
            {{--ajax: '{!! route('backend.orders.datatable') !!}',--}}
            {{--columns: [--}}
                {{----}}
