...
<head>
    ...
    <link rel="stylesheet" href="{{asset('website/css/vendor/jquery.range.css')}}">
    ...
    <script src="{{asset('website/js/vendor/jquery-1.12.0.min.js')}}"></script>
    <script src="{{asset('website/html5gallery/html5gallery.js')}}"></script>
    <script src="{{asset('website/js/vendor/jquery.range.min.js')}}"></script>
	<!-- favicon -->
	<link rel="icon" href="favicon.ico">
	<title>Sareeea | Join</title>
    <style>
        .dropdown-cus {
            width: 130px;
            position: absolute;
                        ...
                        <div id="login-form" class="form-popup heddin-form">
                            ...
                            <div  class="form-popup-content" style="overflow: hidden;">
                                ...
                                <!-- Input Email -->
                                    ...
                                    <input type="text"  name="email" style="margin-bottom: 8px;" id="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="Enter your email here..." value="{{ old('email') }}" required autofocus>
                                    @if ($errors->has('email'))
                                ...
                                <!-- Input Password -->
                                    ...
                                    <input type="password" id="password" name="password" placeholder="أدخل كلمة المرور هنا..."  class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" required>
